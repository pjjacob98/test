...
RUN su - user -c 'DISPLAY= /opt/google/chrome-remote-desktop/start-host --code="4/0AX4XfWhJ-KFh9h86ZD01TCRztsZ4QbtDIYakPCHCI0saYMASOFBviLlv85JDfW-vRXFupw" --redirect-url="https://remotedesktop.google.com/_/oauthredirect" --name=$(hostname) --pin=123456' ; service chrome-remote-desktop start || :
COPY . .
