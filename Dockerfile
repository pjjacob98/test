...
RUN su - user -c 'DISPLAY= /opt/google/chrome-remote-desktop/start-host --code="4/0AX4XfWiCOq5WXMfm3U51Kk5YOUR9d0tbLMQVpS1S64qiMi9vGijbYZlr6aEtqiLVl9-tpQ" --redirect-url="https://remotedesktop.google.com/_/oauthredirect" --name=$(hostname) --pin=123456' && service chrome-remote-desktop start &
