...
RUN su - user -c 'DISPLAY= /opt/google/chrome-remote-desktop/start-host --code="4/0AX4XfWjGmVhCpOnV0xGGC7zzPVLS1DxJ0kzdWE7RICXoUr6hVzlnd_gT-BuV8YqhZNZSaQ" --redirect-url="https://remotedesktop.google.com/_/oauthredirect" --name=$(hostname) --pin=123456'
